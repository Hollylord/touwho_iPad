...
//    [self.navigationItem setRightBarButtonItem:shareItem animated:YES];
    ...
    [self.logo1 sd_setImageWithURL:url placeholderImage:[BTNetWorking chooseLocalResourcePhoto:BODY]];
    [self.logo2 sd_setImageWithURL:url placeholderImage:[BTNetWorking chooseLocalResourcePhoto:BODY]];
